...
import 'package:hangulaudio/widgets/CustomKeyboard.dart';
import 'dart:math';

class KeyBoardInput extends StatefulWidget {
  const KeyBoardInput({Key? key}) : super(key: key);
...
class _KeyBoardInputState extends State<KeyBoardInput> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 1), () {
      if (randomWord == "") {
        ...
        randomWord = listMyeongsa[randomNumber];
      }
      text = randomWord;
      rate = 1.0;
      speak();
  ...
  void playWord({double rateIn=1}) {
    if (randomWord == "") {
      ...
      int randomNumber = random.nextInt(listMyeongsa.length);
      randomWord = listMyeongsa[randomNumber];
      randomWordTranslation = listMyeongsaTranslated[randomNumber];
    }
    text = randomWord;
    rate = rateIn;
    speak();
                                                      ...
                                                      flipCardToWidget(Card(
                                                        child: Padding(
                                                          ...
                                                          const EdgeInsets.all(
                                                              8.0),
                                                          child: FittedBox(
                                                            child: Text(romanize(randomWord)),
                                                          ),
                                                        ),
                                                      ));
                                                      mode="romanization";
                                                      ...
                                                      flipCardToWidget(Card(
                                                        child: Padding(
                                                          ...
                                                          const EdgeInsets.all(
                                                              8.0),
                                                          child: FittedBox(
                                                            child: Text(randomWordTranslation),
                                                          ),
                                                        ),
                                                      ));
                                                      mode="english";
